 ...
 * 5. Проверить победу
 * 6. TODO Проанализировать и почистить код где это возможно
 * 7. TODO ** Искусвенный интелект для победы компьютера
 * . . . [0][1 2 3]
 * . . . [1][1 2 3]
 * . . . [2][1 2 3]
 */
...
public class TicTacToe {
    ...
    static void init() {
        ...
        do {
            ...
            // TODO Предусмотреть ничью чтобы завершить игру
        } while (!isWin);


        // TODO Вынести Поздравление с победой в отдельную функцию
    ...
    static boolean checkWin(char[][] field, char currentPlayerSign) {
        ...
        // TODO Завершить все возможнные проверки на победу

        return false;
    }

    static char switchPlayerSign(char currentPlayerSign) {
        // TODO Переделать на тернарный оператор
        // TODO Вынести проверку игрока-человека в отдельную функцию и применить ее
    ...
    static void doMovePlayer(char[][] field, char playerSign) {
        // TODO Проверка на ввод координат выходящих за пределы поля 3х3
